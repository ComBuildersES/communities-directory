import{ha as $e,jq as ta,jp as Q,K as oa,jg as _e,gM as Pa,dl as U,n as $,lU as Ra,_ as me,g3 as ra,jU as ne,a2 as s,a3 as be,a4 as Fa,eO as oe,fc as Da,fg as je,fj as ja,fh as Va,c_ as Ba,i9 as Ha,kC as Wa,kO as Ua,b_ as qa,an as _,bN as Ya,k$ as ka,pg as Za,kU as Ve,js as Be,aD as Xa,as as Ja,cL as Te,dh as Ka,dj as He,ap as Qa,gP as et,Y as at}from"./index-C1MgvA8f.js";import{H as tt}from"./InterleavedLayout-nBc24Dqc.js";import{n as g,u as ee,t as We,o as we,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as z,a as T,t as he}from"./NormalAttribute.glsl-A_obbmZ5.js";import{aZ as rt,a_ as it,a$ as G,b0 as nt,b1 as st,b2 as lt,D as se,p as ct,K as dt,q as ut,e as I,an as R,a as j,a2 as V,b3 as B,a4 as K,G as N,a6 as H,au as mt,a5 as ht,b4 as ft,ak as F,b5 as pt,J as ia,as as na,F as sa,aX as la,S as vt,P as Ee,Q as fe,I as ca,b6 as gt,g as le,aP as xt,T as bt,U as Me,R as re,k as da,o as O,b7 as h,aO as ze,B as Oe,C as ce,j as Tt,b8 as wt,b9 as Mt,z as ua,L as St,aa as yt,ba as ma,bb as ha,c as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,H as ue,bd as ba,W as Ct,V as Ue,af as Nt,ag as Ot,ah as $t,ai as _t,ab as Et,ac as zt,ad as At,ae as It,aj as Gt,al as P,$ as d,v as Lt,A as Se,am as Pt,az as Rt,x as Ft,d as Dt,ao as jt,y as Vt,aJ as Bt}from"./Geometry-C2zEtogJ.js";import{i as A,a as qe,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{B as Ae,g as Ie,f as Ht}from"./renderState-Dfy6inqQ.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Ge}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-BywgzFsu.js";import{e as Le,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import"./boundedPlane-C6YIlN-y.js";import"./sphere-CWfrlGbJ.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
...
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:$e(e.normalType);case T.COUNT:}}let Yt=class extends rt{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Le()}},kt=class extends nt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Le(),this.toMapSpace=ta()}};function ar({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||oa(n,_e))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Zt=Q(1,1,.5),tr=Q(0,.6,.2),or=Q(0,1,.2);function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`)):o===1?(t.uniforms.add(new O("lightingAmbientSH_R",({lighting:i})=>_(E,i.sh.r[0],i.sh.r[1],i.sh.r[2],i.sh.r[3])),new O("lightingAmbientSH_G",({lighting:i})=>_(E,i.sh.g[0],i.sh.g[1],i.sh.g[2],i.sh.g[3])),new O("lightingAmbientSH_B",({lighting:i})=>_(E,i.sh.b[0],i.sh.b[1],i.sh.b[2],i.sh.b[3]))),t.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===2&&(t.uniforms.add(new se("lightingAmbientSH0",({lighting:i})=>U(ea,i.sh.r[0],i.sh.g[0],i.sh.b[0])),new O("lightingAmbientSH_R1",({lighting:i})=>_(E,i.sh.r[1],i.sh.r[2],i.sh.r[3],i.sh.r[4])),new O("lightingAmbientSH_G1",({lighting:i})=>_(E,i.sh.g[1],i.sh.g[2],i.sh.g[3],i.sh.g[4])),new O("lightingAmbientSH_B1",({lighting:i})=>_(E,i.sh.b[1],i.sh.b[2],i.sh.b[3],i.sh.b[4])),new O("lightingAmbientSH_R2",({lighting:i})=>_(E,i.sh.r[5],i.sh.r[6],i.sh.r[7],i.sh.r[8])),new O("lightingAmbientSH_G2",({lighting:i})=>_(E,i.sh.g[5],i.sh.g[6],i.sh.g[7],i.sh.g[8])),new O("lightingAmbientSH_B2",({lighting:i})=>_(E,i.sh.b[5],i.sh.b[6],i.sh.b[7],i.sh.b[8]))),t.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
return outColor;
}`);break;default:$e(e.pbrMode);case h.COUNT:}}let mo=class extends ua{constructor(e,t,o){super(e,"mat4",Ge.Draw,(i,n,c,m)=>i.setUniformMatrix4fv(e,t(n,c,m)),o)}};class ho extends ua{constructor(e,t,o){super(e,"mat4",Ge.Pass,(i,n,c)=>i.setUniformMatrix4fv(e,t(n,c)),o)}}function _a(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new ho("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),za(a))}function Ea(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new mo("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),za(a))}function za(a){const e=a.fragment;e.include(ya),e.uniforms.add(new da("shadowMap",t=>t.shadowMap.depthTexture),new St("numCascades",t=>t.shadowMap.numCascades),new O("cascadeDistances",t=>t.shadowMap.cascadeDistances)).code.add(r`int chooseCascade(float depth, out mat4 mat) {
