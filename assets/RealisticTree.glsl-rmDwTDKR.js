import{hm as $e,jA as ta,jz as Q,Q as oa,jq as ze,gY as Pa,dx as U,n as $,lW as Ra,gh as ra,k2 as ne,J as s,K as be,M as Fa,f5 as oe,fu as Da,fy as je,fB as ja,fz as Va,d9 as Ba,il as Ha,kJ as Wa,kV as Ua,c9 as qa,an as z,bY as Ya,l6 as ka,p8 as Za,k$ as Ve,jC as Be,aD as Xa,as as Ja,cW as Te,dt as Ka,dv as He,ap as Qa,g$ as et,a0 as at}from"./Map-BQLhjbmA.js";import{H as tt}from"./InterleavedLayout-DlhVkPiH.js";import{n as g,u as ee,t as We,o as we,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as _,a as T,t as me}from"./NormalAttribute.glsl-x2dQdaNS.js";import{aZ as rt,a_ as it,a$ as G,b0 as nt,b1 as st,b2 as lt,D as se,p as ct,K as dt,q as ut,e as I,an as R,a as j,a2 as V,b3 as B,a4 as K,G as N,a6 as H,au as mt,a5 as ht,b4 as ft,ak as F,b5 as pt,J as ia,as as na,F as sa,aX as la,S as vt,P as Ee,Q as he,I as ca,b6 as gt,g as le,aP as xt,T as bt,U as Me,R as re,k as da,o as O,b7 as h,aO as _e,B as Oe,C as ce,j as Tt,b8 as wt,b9 as Mt,z as ua,L as St,aa as yt,ba as ma,bb as ha,c as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,H as ue,bd as ba,W as Ct,V as Ue,af as Nt,ag as Ot,ah as $t,ai as zt,ab as Et,ac as _t,ad as At,ae as It,aj as Gt,al as P,$ as d,v as Lt,A as Se,am as Pt,az as Rt,x as Ft,d as Dt,ao as jt,y as Vt,aJ as Bt}from"./Geometry-DoKVT0Vd.js";import{i as A,a as qe,e as ae,n as fe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{_ as pe}from"./index-BNgLIX9i.js";import{B as Ae,g as Ie,f as Ht}from"./renderState-AMdrXmCR.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Ge}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-2aadgXn4.js";import{e as Le,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import"./boundedPlane-D69WVLi8.js";import"./sphere-CiI9bFGK.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
...
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:$e(e.normalType);case T.COUNT:}}let Yt=class extends rt{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Le()}},kt=class extends nt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Le(),this.toMapSpace=ta()}};function tr({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||oa(n,ze))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Zt=Q(1,1,.5),or=Q(0,.6,.2),rr=Q(0,1,.2);function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`)):o===1?(t.uniforms.add(new O("lightingAmbientSH_R",({lighting:i})=>z(E,i.sh.r[0],i.sh.r[1],i.sh.r[2],i.sh.r[3])),new O("lightingAmbientSH_G",({lighting:i})=>z(E,i.sh.g[0],i.sh.g[1],i.sh.g[2],i.sh.g[3])),new O("lightingAmbientSH_B",({lighting:i})=>z(E,i.sh.b[0],i.sh.b[1],i.sh.b[2],i.sh.b[3]))),t.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const ea=$(),E=ta();function uo(a){const e=a.fragment.code;e.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
return outColor;
}`))}function dr(a,e){const t=a.fragment.code;a.include(_e),t.add(r`
...
return outColor;
}`);break;default:$e(e.pbrMode);case h.COUNT:}}let mo=class extends ua{constructor(e,t,o){super(e,"mat4",Ge.Draw,(i,n,c,m)=>i.setUniformMatrix4fv(e,t(n,c,m)),o)}};class ho extends ua{constructor(e,t,o){super(e,"mat4",Ge.Pass,(i,n,c)=>i.setUniformMatrix4fv(e,t(n,c)),o)}}function za(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new ho("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),_a(a))}function Ea(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new mo("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),_a(a))}function _a(a){const e=a.fragment;e.include(ya),e.uniforms.add(new da("shadowMap",t=>t.shadowMap.depthTexture),new St("numCascades",t=>t.shadowMap.numCascades),new O("cascadeDistances",t=>t.shadowMap.cascadeDistances)).code.add(r`int chooseCascade(float depth, out mat4 mat) {
